namespace MT.GridView.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MT.GridView.Models.MyDbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = true;
            ContextKey = "MT.GridView.Models.MyDbContext";
        }

        protected override void Seed(MT.GridView.Models.MyDbContext context)
        {            
